    ...
    <div className="space-y-20 pt-28 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-950/60 border border-red-800/60">
          ...
          <span className="text-xs font-bold text-red-400 uppercase tracking-widest">COMPLETE ADVERTISING CATALOGUE</span>
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white">
          Our Specialized <span className="text-red-500">Services & Solutions</span>
        </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {MAIN_SERVICES.map((service) => (
            <div
              key={service.id}
              className="rounded-3xl bg-neutral-950 border border-neutral-800/80 overflow-hidden flex flex-col justify-between hover:border-red-600/50 transition-all shadow-xl group"
            >
              <div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="pt-2 space-y-2">
                    <span className="text-[11px] font-bold text-red-500 uppercase tracking-wider">Key Benefits</span>
              ...
              <div className="p-6 pt-0 flex items-center gap-3">
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-red-600 hover:bg-red-500 text-white text-xs font-bold shadow-md shadow-red-950/80 transition-all"
                >
                  ENQUIRE NOW
                </button>
                <Link
                  to={service.path}
                  className="px-4 py-3 rounded-xl bg-neutral-900 hover:bg-neutral-800 text-gray-300 text-xs font-semibold border border-neutral-800 transition-all"
                >
                  Details
                </Link>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 rounded-3xl bg-neutral-950 border border-neutral-800 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">We fabricate signboards and print materials according to your exact requirements.</p>
          </div>
          <a
