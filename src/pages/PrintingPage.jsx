    ...
    <div className="space-y-20 pt-28 pb-16">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-950/60 border border-red-800/60">
          ...
          <span className="text-xs font-bold text-red-400 uppercase tracking-widest">PREMIUM PRINTING SERVICES</span>
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white">
          Visiting Cards & <span className="text-red-500">Royal Wedding Invitations</span>
        </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-900 border border-neutral-800 text-xs font-bold text-gray-300">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-3 rounded-xl bg-neutral-950 border border-neutral-800 text-gray-300">
                <span className="font-bold text-white block">Velvet Touch Laminate</span>
                Ultra soft matte tactile finish
              </div>
              <div className="p-3 rounded-xl bg-neutral-950 border border-neutral-800 text-gray-300">
                <span className="font-bold text-white block">Gold & Red Foil Stamping</span>
                Metallic reflective foil detail
              </div>
              <div className="p-3 rounded-xl bg-neutral-950 border border-neutral-800 text-gray-300">
                <span className="font-bold text-white block">Spot UV & Textured Gloss</span>
                Raised glossy logo elements
              </div>
              <div className="p-3 rounded-xl bg-neutral-950 border border-neutral-800 text-gray-300">
                <span className="font-bold text-white block">Metallic Gilded Edges</span>
          ...
          <div className="rounded-3xl overflow-hidden border border-neutral-800 shadow-2xl h-[380px]">
            <img
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 rounded-3xl overflow-hidden border border-neutral-800 shadow-2xl h-[380px]">
            <img
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 rounded-3xl bg-neutral-950 border border-neutral-800 text-center space-y-4">
          ...
          <p className="text-xs text-gray-400 max-w-xl mx-auto">Visit our Khoda Colony workshop to inspect physical paper samples and foil treatments.</p>
          <a
